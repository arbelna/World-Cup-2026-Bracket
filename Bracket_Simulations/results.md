...
- **Calibration:** `market_all` is better calibrated overall (ECE 0.0095 vs 0.0242). Both models are well-calibrated on low-probability teams - the large majority of cases - and sit close to the diagonal in the 0-0.3 range. The model's deficit is concentrated in the 0.5-0.7 bin (-0.128 (avg pred 0.57, observed 0.70)): it consistently underrates mid-range favourites. The market is sharper in that range (-0.021 (avg pred 0.61, observed 0.63)). This underrating is most pronounced at the group and R16 stages; from the quarter-finals onward, team probabilities consolidate outside the 0.5-0.7 range and the calibration gap has negligible practical impact on bracket outcomes.

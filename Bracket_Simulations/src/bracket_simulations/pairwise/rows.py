...
def build_row_from_dataset(match: dict[str, Any]) -> MatchRow | None:
    ...
    return MatchRow(
        ...
        z_log_top_15_average_value_team_a=float(match.get("z_log_top_15_average_value_team_a") or 0.0),
        z_log_top_15_average_value_team_b=float(match.get("z_log_top_15_average_value_team_b") or 0.0),
        y_soft=y_soft,
    )
